...
#
    ...
    REPOSITORY=Db2-Click-To-Containerize-Lab
...
GITHUB=https://$DTE_GIT/$REPOSITORY
ASKREFRESH=$NOTEBOOKDIR/db2pot-refresh.txt
ASKLEGAL=$NOTEBOOKDIR/db2pot-legal.txt
...
export PATH=/home/db2inst1/anaconda3/bin:/home/db2inst1/anaconda3/condabin:$PATH
...
cp $NOTEBOOKDIR/custom.css ~/.jupyter/custom/custom.css

cp $NOTEBOOKDIR/media/logo.png ~/.jupyter/custom/logo.png

sleep 2
echo "# trusting notebooks"
jupyter trust /home/db2inst1/notebooks/*.ipynb >> $LOGFILE
echo "# trusted notebooks"
